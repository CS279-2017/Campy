...
function loadTestData(callback) {
    ...
    var testCampsite = new Campsite({name: "SomeName", creator: "harrisonstall", rating: 5, description: "There are some cool waterfalls. Highly recommend.",
                                    directions: "Hop the boulder", price: 0, lat: 36.142980, long: -86.805682, size: "small", tags: ["waterfall", "fun"],
                                    fire: true, reviews: [reviewID]});

    var testCampsite2 = new Campsite({name: "SomeName1", creator: "turnerstrayhorn", rating: 5, description: "Great hiking trails! And great hot chicken!",
    ...
    var testCampsite3 = new Campsite({name: "SomeName2", creator: "turnerstrayhorn", rating: 4, description: "Good southern camping!",
                                    directions: "Family style", price: 20, lat: 36.1151, long: -86.6901, size: "large", tags: ["wheelchair-accessible", "bathrooms"],
                                    fire: false, reviews: []});

    var testCampsite4 = new Campsite({name: "SomeName3", creator: "turnerstrayhorn", name: "somesite", rating: 4, description: "Testsite",
                                    directions: "tbd", price: 20, lat: 36.1351, long: -86.7901, size: "large", tags: ["pet-friendly", "family-friendly"],
                                    fire: false, reviews: []});

    var testCampsite5 = new Campsite({name: "SomeName3", creator: "harrisonstall", name: "someothersite", rating: 4, description: "Testsite",
                                    directions: "tbd", price: 20, lat: 36.2151, long: -86.4901, size: "large", tags: ["family-friendly", "wheelchair-accessible"],
                                    fire: false, reviews: []});

    var testCampsite6 = new Campsite({name: "SomeName4", creator: "longadams", name: "somenewsite", rating: 4, description: "Testsite",
